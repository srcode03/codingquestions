<h2><a href="https://www.geeksforgeeks.org/problems/making-elements-distinct3139/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Making elements distinct</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a sorted integer array. We need to make array elements distinct by increasing values and keeping the array sum minimum possible. We need to print the minimum possible sum as output.</span></p>
